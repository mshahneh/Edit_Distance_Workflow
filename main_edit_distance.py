...
def main(cached_structures, cached_motifs, top_limit, data_x, out_dir, data_y, important_columns, verbose=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--calculate_mces', action='store_true', help='Calculate MCES.')
    parser.add_argument('--calculate_motif_based', action='store_true', help='Calculate motif based edit distance.')
    ...
    if not args.calculate_mces:
        important_columns.remove('mces')
    if not args.calculate_motif_based:
        important_columns.remove('motif_distance')
        important_columns.remove('motif_removed')
        important_columns.remove('motif_added')
    main(cached_structures, motifs_dict, args.top_limit, data_x, out_dir, data_y, important_columns, args.verbose)
